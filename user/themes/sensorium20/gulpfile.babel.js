...
// We don't need this, grav takes case of this
// function pages() {
...
function watch() {
  ...
  // gulp.watch('src/helpers/**/*.js').on('all', gulp.series(browser.reload));
  gulp.watch('src/assets/scss/**/*.scss').on('all', sass);
  gulp.watch('src/assets/js/**/*.js').on('all', gulp.series(javascript, browser.reload));
  gulp.watch('src/assets/img/**/*').on('all', gulp.series(images, browser.reload));
  gulp.watch('templates/**/*.twig').on('all', gulp.series(browser.reload));
